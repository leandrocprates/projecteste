...
public class TicTacToeServer extends JFrame 
{
   ...
   public void execute()
   {
       ...
       outputArea.append("Thread Principal -- Thread Num= " +Thread.currentThread().getId()+"\n");
      ...
      try
      {
         outputArea.append("Deixando de suspender. Thread Num= " +Thread.currentThread().getId()+"\n");
   ...
   private class Player implements Runnable 
   {
      ...
      public void run()
      {
         ...
         try 
         {
            ...
            outputArea.append("Executando Run. Thread Num= " +Thread.currentThread().getId()+" Jogador = "+playerNumber+"\n");
