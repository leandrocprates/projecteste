...
// exemplo de uma saida completa de todo o programa

//Scheme:    http
//Authority: www.appinf.com:81
//Path:      /sample
//Query:     example-query
//Fragment:  somewhere
//https://www.appinf.com/another%20sample
//https://www.appinf.com/another sample
//http://admin123@localhost:8060/reload
...
// saida:
	...
	uri2.setPath("/another sample");
        ...
        // imprime https://www.appinf.com/another%20sample
	std::cout << uri2.toString() << std::endl;
        // tira caracters especiais: %
        URI::decode(uri2.toString() , url );
        // imprime https://www.appinf.com/another sample
        std::cout << url << std::endl;

        URI uri3;
        uri3.setScheme("http");
        uri3.setHost("localhost");
        uri3.setPort(8060);
        uri3.setPath("/reload");
        uri3.setUserInfo("admin123");

	std::cout << uri3.toString() << std::endl;
