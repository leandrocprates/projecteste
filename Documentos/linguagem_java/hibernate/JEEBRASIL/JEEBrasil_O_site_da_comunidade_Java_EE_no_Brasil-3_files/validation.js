...
Validation.addAllThese([
	['required', 'Este campo é obrigatório.', function(v) {
	...
	['validate-email', 'Por favor, digite um e-mail válido.', function (v) {
				return Validation.get('IsEmpty').test(v) || /\w{1,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/.test(v)
			}],
	['validate-url', 'Por favor, digite uma URL válida.', function (v) {
				return Validation.get('IsEmpty').test(v) || /^(http|https|ftp):\/\/(([A-Z0-9][A-Z0-9_-]*)(\.[A-Z0-9][A-Z0-9_-]*)+)(:(\d+))?\/?/i.test(v)
			}],
	['validate-date-au', 'Por favor, use este formato: dd/mm/aaaa. Por exemplo: 17/03/2006 para 17 de março de 2006.', function(v) {
