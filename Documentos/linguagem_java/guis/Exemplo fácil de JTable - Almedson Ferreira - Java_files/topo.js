...
$(document).ready( function() {
	...
	/* Exibição do label interno do campo de pesquisa */
    /* ====================================================================== */
    ...
    /* Exibição do menu de configurações da conta */
    /* ====================================================================== */
    ...
    /* Ocultar exibição do menu popup */
    /* ====================================================================== */
    ...
    $(document).ajaxSend(fnAjaxSend = function(evt, request, settings) {
                                                    ...
                                                    $("body").append("<div id='ajaxLoading'>carregando... <img src='"+im.staticdominio+"img/geral/loading.gif' alt='' /></div>");
