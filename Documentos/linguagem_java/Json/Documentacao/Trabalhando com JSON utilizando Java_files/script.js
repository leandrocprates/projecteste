...
hwPal.codigo="$1<a href='#' onClick='hwClick(\"$2\");return false;' style='cursor: hand; color:#3a7fee; text-decoration:underline; border-bottom:dotted 1px;' onmouseover='hwShow(event, this, \"$2\"); this.style.cursor=\"hand\"; this.style.textDecoration=\"underline\"; this.style.borderBottom=\"solid\";'  onmouseout='hideMaybe(this, \"$2\"); this.style.cursor=\"hand\"; this.style.textDecoration=\"underline\"; this.style.borderBottom=\"dotted 1px\"; ' oncontextmenu=\"return false;\">$2</a>$4";
...
var xxx="<div id='HW_Container_Custom'><div id='HW_Topo'><div id='HW_Espaco_Custom'>&nbsp;</div><div id='HW_Fechar'><a alt='HOTWords' onclick=\"javascript: hideBL('HOTWordsTitle');\" ><img src='http://img.hotwords.com.br/img/transp_hotwords_2.gif' alt='' width='12' height='17' border='0' /></a></div></div><div id='HW_Conteudo' onclick=\"window.open('http://zone116.hotwords.com.br/redir2.jsp"+ lnk +"','_blank');\"><div id='HW_Texto'>"+ txt + "</div><div id='HW_Link'><p>Clique aqui e saiba mais</p></div></div><div id='HW_Logo_Custom'><a href='http://site.hotwords.com.br/?r=3590'  alt='HOTWords' target='_blank' onmouseover=\"window.status=''; return true;\"><img src='http://zone116.hotwords.com.br/img2.jsp"+ lnk +"' width='100' height='10' border='0' /></a></div></div>";
printHW(e, obj, xxx);
}
...
var ok = hw_exl('http://zone116.hotwords.com.br/mostraV2.js?c=49&h=ode1odq4mZaXiYnUBYmJndK%23&pl=' + p + '&id=3590&i=' + b + '&p=' + escape(hwPal.encontrados[b]) + '&d=http%3A%2F%2Fwww.oficinadanet.com.br%2Fartigo%2Fjava%2Ftrabalhando_json_com_java%3Futm_source%3Dfeedburner%26utm_medium%3Dfeed%26utm_campaign%3DFeed%253A%2Boficinadanet_rss%2B%2528Oficina%2Bda%2BNet%2B-%2BFeed%2529');
}catch(e){}
}
}
scriptElement = null; 
