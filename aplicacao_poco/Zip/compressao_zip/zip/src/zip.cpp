...
protected:	
	...
	void defineOptions(OptionSet& options)
	{
        ...
        // define as funcoes que serao chamadas por defineOptions
	void handleHelp(const std::string& name, const std::string& value)
	{
		std::cout<< "dentro da funcao handleHelp" << std::endl ;
	...
	{
		std::cout<< "dentro da funcao handleFile" << std::endl ;
		std::cout<< "name :" << name  << std::endl ;
	...
	void onDone(const void*, const Poco::Zip::ZipLocalFileHeader& hdr)
	{
        ...
        // funcao chamada por run de Application
